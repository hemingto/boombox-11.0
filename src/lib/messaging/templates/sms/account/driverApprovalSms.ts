...
export const driverApprovalSms: MessageTemplate = {
  text: `Congratulations \${firstName}! Your Boombox driver account has been approved. You can now start \${statusMessage}. Log in to your account page to start accepting jobs!`,
