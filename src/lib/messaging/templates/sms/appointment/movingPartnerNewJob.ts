...
export const movingPartnerNewJobWithDriverSms: MessageTemplate = {
  text: 'Boombox Job Update: Customer ${customerName}, ${appointmentType} on ${appointmentDate} at ${appointmentTime}. Appt ID: ${appointmentId}. ${driverName} assigned. Log on to your account page to edit the driver assignment.',
  requiredVariables: [
    'customerName',
    'appointmentType',
    'appointmentDate',
  ...
  domain: 'appointment',
  description:
    'SMS sent to moving partners when a new job is assigned with a driver already selected',
};
...
export const movingPartnerNewJobSms: MessageTemplate = {
  text: 'New Boombox Job: Customer ${customerName}, ${appointmentType} on ${appointmentDate} at ${appointmentTime}. Assign driver on your account page. Appt ID: ${appointmentId}.',
  requiredVariables: [
    'customerName',
    'appointmentType',
    'appointmentDate',
  ...
  domain: 'appointment',
  description:
    'SMS sent to moving partners when a new job is assigned and they need to select a driver',
};
