...
export const customerCancellationNotificationSms: MessageTemplate = {
  text: 'Boombox: Customer cancelled appointment ${appointmentId} scheduled for ${appointmentDate} at ${appointmentTime}. Reason: ${cancellationReason}',
  requiredVariables: [
    'appointmentId',
    'appointmentDate',
    'appointmentTime',
  ...
  domain: 'booking',
  description:
    'SMS sent to drivers and movers when customer cancels their appointment',
};
