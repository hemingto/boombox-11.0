...
export const movingPartnerNewJobManualAssignSms: MessageTemplate = {
  text: 'Boombox: New job booked! ${appointmentType} on ${appointmentDate} at ${appointmentTime}. Customer: ${customerName}. Please assign a driver through your Jobs page in your Boombox account.',
  requiredVariables: [
    'appointmentType',
    'appointmentDate',
    'appointmentTime',
  ...
  domain: 'booking',
  description:
    'SMS sent to moving partners when a new job is booked and they need to manually assign a driver through their Boombox account',
};
