...
export function UnassignedDriverPage({ taskId }: UnassignedDriverPageProps) {
  ...
  const handleUpdate = async () => {
    ...
    if (task?.actionUrl) {
      const appointmentId = task.actionUrl.split('jobId=')[1];
      if (appointmentId) {
        try {
      ...
      <div className="w-full sm:max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-surface-primary rounded-lg shadow-sm">
          <div className="p-6 space-y-6">
            {/* Moving Partner Card */}
            {task.movingPartner && (
              <div className="bg-status-bg-error rounded-lg p-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="relative bg-white rounded-full h-12 w-12 overflow-hidden">
                      <Image
                        src={task.movingPartner.imageSrc || '/default-image.jpg'}
                  ...
                  <div className="flex items-center gap-2 mr-4">
                    ...
                    >
                      <div className="bg-status-error p-2 rounded-full">
