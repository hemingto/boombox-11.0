     ...
     <div className="p-6 space-y-10">
      ...
      <div className="bg-cyan-500 rounded-lg p-6">
       <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
         <div className="relative bg-cyan-600 rounded-full h-12 w-12 overflow-hidden flex items-center justify-center">
      ...
      <div className="flex justify-end pt-4">
       <Button
        ...
        disabled={didCleanUnit !== 'Yes' || cleaningPhotos.length === 0}
        loading={isSubmitting}
        variant="primary"
        className="!bg-cyan-500 hover:!bg-cyan-400 active:!bg-cyan-400 disabled:!bg-cyan-500"
