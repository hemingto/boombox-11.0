   ...
   >
    ...
    >
     {steps.map((step, index) => (
      ...
      >
       <article className="relative bg-surface-tertiary w-[297.6px] sm:w-[372px] h-[569.6px] sm:h-[712px] rounded-md transform transition-transform duration-300 sm:hover:scale-[102%] cursor-pointer hover:z-10 overflow-hidden">
        ...
        <div className="relative">
         ...
         <h2 className="ml-5 mb-2 text-text-primary">{step.subtitle}</h2>
         <p className="mx-5 text-text-primary">{step.description}</p>
        </div>
       </article>
      </Link>
     ))}
