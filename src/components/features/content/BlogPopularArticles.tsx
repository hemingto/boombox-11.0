...
export const BlogPopularArticles: React.FC = () => {
  ...
  return (
    <div className="lg:mx-12 mx-6 sm:pb-24 sm:mb-24 pb-12 mb-12 md:border-b-2 md:border-border">
        ...
        {isMobile && showPagination && (
          <div className="flex mt-4 sm:mt-0" role="navigation" aria-label="Popular articles pagination">
            <button
              ...
              className={`rounded-full mr-1 bg-surface-secondary active:bg-surface-tertiary p-2 transition-colors ${
            ...
            <button
              ...
              className={`rounded-full bg-surface-secondary active:bg-surface-tertiary p-2 transition-colors ${
