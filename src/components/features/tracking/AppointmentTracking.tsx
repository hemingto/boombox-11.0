  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 mb-64">
      ...
      <p className="text-sm text-zinc-950 mb-6">
        {format(appointmentDate, "EEEE, MMM do 'scheduled between' h:mma")} -{' '}
        {format(addHours(appointmentDate, 1), 'h:mma')}
      </p>
                    ...
                    <div key={index} className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex gap-2">
                          {step.action &&
                            (step.action.label === 'Track location' ||
                              (unitIndex === 0 &&
                          ...
                          {unitIndex === 0 && step.secondaryAction && (
                            ...
                            >
                              {step.secondaryAction.iconName &&
                                React.createElement(
                                  iconMap[step.secondaryAction.iconName],
                                  { className: 'w-5 h-5' }
                                )}
