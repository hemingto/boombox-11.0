...
const defaultSteps: Step[] = [
  {
    stepNumber: 1,
    title: 'Request',
    description: "Book online. We'll arrive when and where you need us. Get a storage unit delivered to your door at the push of a button. Storage has never been this simple.",
    image: '/placeholder.jpg',
    imageAlt: 'Customer booking Boombox storage online - request delivery service',
  },
  {
    stepNumber: 2,
    title: 'Pack',
    description: "Save money by packing your storage unit or hire a local pro. You can pack the unit yourself or we can match you with a local pro to help with the heavy lifting.",
    image: '/placeholder.jpg',
    imageAlt: 'Packing belongings into Boombox storage unit with professional help',
  },
  {
    stepNumber: 3,
    title: 'Store',
    description: "We'll transport your storage unit to our secure facility. Just sit back and relax, as our friendly Boombox driver delivers your Boombox to our 24/7 monitored facility",
    image: '/placeholder.jpg',
  ...
  },
  {
    stepNumber: 4,
    title: 'Deliver',
    description: "Need to access your storage unit? We'll deliver right to your door. It's self storage that comes to you. If you need to grab a box or add a couple items simply request your unit back and we'll deliver it right to your door.",
    image: '/placeholder.jpg',
