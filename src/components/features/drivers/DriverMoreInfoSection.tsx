...
export const DriverMoreInfoSection: React.FC = () => {
  return (
    <section
      className="mt-14 lg:px-16 px-6 sm:mb-48 mb-24"
      aria-labelledby="delivery-info-heading"
    >
      <h1
        id="delivery-info-heading"
        className="mb-10 sm:mb-20 text-text-primary"
      >
      ...
      <div className="flex flex-col lg:flex-row mb-20">
        ...
        <div className="flex flex-col justify-center sm:items-end basis-1/2 sm:text-right lg:ml-8">
          ...
          <p className="mb-10 w-4/6 text-text-primary">
            As a container delivery driver you&apos;ll be responsible for towing
            Boombox storage containers to customer&apos;s addresses. Your
            vehicle must have a towing capacity of 4000lbs and trailer hitch
          </p>
          <Link
          ...
          >
            <button className="btn-primary">Check Qualifying Vehicles</button>
          </Link>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row">
        <div className="place-content-center basis-1/2 md:mr-8">
          ...
          <p className="mb-10 w-4/6 text-text-primary">
            As a packing supply delivery driver you&apos;ll be responsible for
            delivering packing supplies to customer&apos;s addresses. Packing
            supplies include cardboard boxes, moving blankets, tape, etc. Your
            vehicle does not need towing capabilities
          </p>
          <Link
            href="/vehicle-requirements"
            target="_blank"
        ...
        <div className="flex place-content-end lg:items-center basis-1/2 shrink-0 order-first lg:order-last mb-10 lg:mb-0">
          <div className="relative aspect-video w-full rounded-md overflow-hidden">
            <Image
              src="/driver-signup/packing-supplies-delivery.png"
              alt="Packing supplies including boxes, blankets, and tape"
              fill
              className="object-cover rounded-md"
              loading="lazy"
              quality={85}
