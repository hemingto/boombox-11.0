...
const approvedVehicles: VehicleImage[] = [
  { src: '/vehicle-requirements/accepted-vehicle.png', isApproved: true },
  { src: '/vehicle-requirements/accepted-vehicle-1.png', isApproved: true },
  { src: '/vehicle-requirements/accepted-vehicle-2.png', isApproved: true },
];
...
const notApprovedVehicles: VehicleImage[] = [
  { src: '/vehicle-requirements/rejected-vehicle.png', isApproved: false },
  { src: '/vehicle-requirements/rejected-vehicle-1.png', isApproved: false },
  { src: '/vehicle-requirements/rejected-vehicle-2.png', isApproved: false },
];
