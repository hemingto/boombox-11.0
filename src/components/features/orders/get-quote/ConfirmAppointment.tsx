      ...
      <div className="max-w-lg mx-auto md:mx-0 md:ml-auto">
        ...
        <div className="p-3 sm:mb-4 mb-2 border border-border bg-surface-primary rounded-md max-w-fit mt-4">
          <p className="text-xs text-text-primary">
            You&apos;ll receive updates about the status of your Boombox via
            your phone number
          </p>
        </div>
        ...
        <div className="flex-col gap-2">
          ...
          <div className="mt-4 p-3 sm:mb-4 mb-2 border border-border bg-surface-primary rounded-md max-w-fit">
            <p className="text-xs text-text-primary">
              You won&apos;t be charged anything today. We need your payment
              info to hold your appointment time.
              <br />
              <br />
            </p>
            <button
      ...
      >
        <div className="space-y-4">
          <p className="text-text-primary">
            Reserving is free! You&apos;ll only be charged for your first month
            of storage and the pickup fee after your appointment is completed.
          </p>
          <p className="text-text-primary">
            We&apos;ll run a pre-authorization check 7 days before your
            appointment to ensure there are enough funds. If your appointment is
            in less than 7 days, we&apos;ll do the check right after booking.
            This hold will be released once the check is done.
          </p>
          ...
          <div className="pt-4 pb-4 border-t border-border">
            ...
            <p className="text-text-primary">
              Please reschedule or cancel at least 48 hours in advance to avoid
              a $65 fee. If you cancel on the day of your appointment, the fee
              increases to $150. It&apos;s easy to make changes online!
            </p>
          </div>
        </div>
      </Modal>
