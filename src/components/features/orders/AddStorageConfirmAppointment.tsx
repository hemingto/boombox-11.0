    ...
    <div className="w-full basis-1/2">
      <div className="max-w-lg mx-auto md:mx-0 md:ml-auto">
        ...
        <header className="flex items-center mb-12 gap-2 lg:-ml-10">
          ...
          <h1 className="text-4xl text-text-primary" id="confirmation-title">
            Confirm appointment
          </h1>
        </header>
        ...
        <fieldset className="mb-4">
          ...
          <div>
            ...
            <div id="description-help" className="sr-only">
              Optional field to provide additional details about your location
              that may help with the delivery
            </div>
          </div>
        </fieldset>
