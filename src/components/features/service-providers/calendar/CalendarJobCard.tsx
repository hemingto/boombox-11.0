  ...
  return (
    <>
      ...
      >
        ...
        <footer className="border-t border-border">
          ...
          <button
            ...
            className="px-4 py-4 flex items-center justify-between w-full text-text-primary hover:bg-surface-tertiary active:bg-surface-disabled transition-colors duration-200 rounded-b-lg"
      ...
      >
        {/* Warning Message */}
        <div 
          className="bg-status-bg-warning border border-status-warning rounded-md p-4 mb-6"
          role="alert"
          aria-live="polite"
        >
        ...
        <div className="flex justify-end gap-3">
          <button
            ...
            className="px-5 py-2.5 text-sm font-semibold text-text-primary bg-surface-secondary hover:bg-surface-tertiary active:bg-surface-disabled rounded-md transition-colors duration-200 border border-border"
          ...
          <button
            ...
            className="px-5 py-2.5 text-sm font-semibold bg-primary text-text-inverse hover:bg-primary-hover active:bg-primary-active rounded-md transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-primary"
