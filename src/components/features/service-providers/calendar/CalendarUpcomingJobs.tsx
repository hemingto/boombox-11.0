  ...
  >
   ...
   {!hideOpenCalendarButton && (
    <button
     ...
     className="flex items-center w-fit rounded-md py-2.5 px-3 font-semibold bg-primary text-text-inverse hover:bg-primary-hover active:bg-primary-active font-inter"
