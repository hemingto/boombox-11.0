...
export const AppointmentDetailsPopup: React.FC<AppointmentDetailsPopupProps> = ({
  ...
  return (
    <Modal
      ...
      className="bg-surface-primary p-8 rounded-lg"
    >
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <button 
          onClick={onClose} 
          className="text-primary hover:bg-surface-tertiary rounded-full p-2 transition-colors"
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-xs">assigned driver</p>
                    </div>
                  </div>
                  <a 
              ...
              {appointment.orders && appointment.orders.length > 0 ? (
                appointment.orders.map((order: any, index: number) => (
                  ...
                  >
                    ...
                    {order.status && (
                      <p className="text-xs text-text-secondary">Status: {order.status}</p>
                    )}
                  </div>
                ))
              ) : (
