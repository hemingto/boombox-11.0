    ...
    <div className={className} role="region" aria-label="Coverage area selection">
      ...
      >
        <button
          ...
          className="p-2 bg-surface-tertiary rounded-full transition-colors duration-200 hover:bg-surface-secondary active:bg-surface-disabled disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-border-focus focus:ring-offset-2"
