 ...
 * 
 * API ROUTES:
 * - POST /api/auth/admin-login - Send verification code to admin
 * - PUT /api/auth/admin-login - Verify code and authenticate admin
 * 
    ...
    <div>
     <div className="flex items-center justify-center relative">
      ...
      {adminLogin.isCodeSent && (
       <ChevronLeftIcon
        className="absolute left-0 w-8 cursor-pointer text-text-primary hover:text-primary"
     ...
     {adminLogin.isCodeSent && (
      <>
       <VerificationCode
        ...
        description={`Enter the 6-digit verification code sent to your ${
