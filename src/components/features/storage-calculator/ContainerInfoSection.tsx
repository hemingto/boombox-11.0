 ...
 */
const DimensionModalContent: React.FC<DimensionModalContentProps> = ({
  onClose,
}) => (
  <div className="p-6">
    ...
    <div className="flex flex-col sm:flex-row gap-8 mt-10">
      ...
      <div className="flex-1 border-r border-border pr-6">
        ...
        <ul className="text-sm space-y-2 text-text-primary" role="list">
          <li>
            <span className="font-semibold text-text-primary">Length:</span> 95
            ins. or 7ft. 11 in. (241cm)
          </li>
          <li>
      ...
      <div className="flex-1 pl-6">
        ...
        <ul className="text-sm space-y-2 text-text-primary" role="list">
          <li>
            <span className="font-semibold text-text-primary">Length:</span> 96
            ins. or 8ft. (244cm)
          </li>
          <li>
...
export function ContainerInfoSection() {
  ...
  const features: FeatureProps[] = [
    {
      ...
      content: (
        <>
          <p className="mb-6">
            Boomboxes are 5 ft. wide 8ft. long and 8ft. tall. That&apos;s 320
            cubic feet of storage, enough to store a studio apartment full of
            items
          </p>
          <button
            onClick={() => setIsDimensionsModalOpen(true)}
            className="flex items-center cursor-pointer text-primary hover:text-primary-hover"
  ...
  return (
    ...
    >
      <h1 id="container-info-heading" className="mb-10 text-text-primary">
