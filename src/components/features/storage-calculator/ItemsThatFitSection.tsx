 ...
 * - Replaced bg-slate-100 placeholder cards with OptimizedImage component
 ...
 * - Replaced bg-slate placeholders with OptimizedImage component
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row w-full lg:px-16 px-6 justify-between items-left sm:items-center mb-10">
        <h1 
          ...
          className="text-left text-3xl font-bold text-text-primary"
        >
        ...
        <div className="flex mt-4 sm:mt-0 gap-2" role="group" aria-label="Scroll navigation">
          <button
            ...
            className="rounded-full bg-surface-tertiary active:bg-surface-disabled hover:bg-surface-disabled transition-colors cursor-pointer p-2"
          ...
          {items.map((item, index) => (
            <div key={index} role="listitem" className="flex-none">
              ...
              >
                ...
                {/* Image placeholder - could be replaced with actual product images */}
                ...
                <p className="mx-5 text-text-secondary">
                  {item.description}
                </p>
              </article>
            </Link>
