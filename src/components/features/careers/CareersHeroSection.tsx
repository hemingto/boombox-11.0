...
export function CareersHeroSection({
  heroImageSrc = '/careers/careers-hero.png',
  heroImageAlt = 'Boombox driver looking back at camera from window of truck pulling a Boombox storage container',
      ...
      <div className="md:flex lg:mx-16 mx-6 sm:mb-24 mb-12">
        ...
        <div className="place-content-center items-center basis-5/12 mr-4">
          ...
          <p className="max-w-lg mb-8 text-text-primary">
            We are always looking for talented people to help with our mission
            of making storage as simple and convenient as possible. Think you
            can help? Check out our job listings.
          </p>
