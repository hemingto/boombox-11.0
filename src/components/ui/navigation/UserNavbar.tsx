    ...
    <div className="h-10 w-full py-3 lg:px-16 px-6 flex items-center">
     ...
     <ul className="md:basis-1/2 flex justify-end items-center grow gap-3">
      {showAccessStorageButton && (
       <li>
        <Link href={`/customer/${userId}/access-storage`}>
         <button 
          className={`hidden sm:block py-2.5 px-4 rounded-full font-semibold text-sm text-nowrap font-inter focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ${
           isDarkTheme 
      ...
      {showAddStorageButton && (
       <li>
        <Link href={`/customer/${userId}/add-storage`}>
         <button 
          className={`hidden sm:block py-2.5 px-3 rounded-full font-semibold text-sm text-nowrap font-inter focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ${
           isDarkTheme 
