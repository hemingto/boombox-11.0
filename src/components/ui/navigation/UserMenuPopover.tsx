  ...
  return (
    <div className={`relative inline-block text-left ${className}`} ref={popoverRef}>
      ...
      >
        ...
        <div
          className="flex border-t border-border h-12 items-center justify-center text-nowrap text-sm cursor-pointer text-text-primary hover:bg-surface-tertiary active:bg-surface-disabled"
        >
          <button
            ...
            className="w-full px-4 py-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-inset rounded"
          >
