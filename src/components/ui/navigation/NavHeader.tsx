...
export const NavHeader = () => {
  return (
    <header role="banner">
      <nav
        className="w-full bg-primary pt-[env(safe-area-inset-top)] flex flex-col"
      ...
      >
        <div className="h-16 w-full py-3 lg:px-16 px-6 flex items-center">
          ...
          <ul
            className="hidden lg:flex lg:gap-10 md:gap-6 basis-1/3 grow justify-center"
            role="list"
          >
            <li>
              <Link
          ...
          <ul
            className="md:basis-1/3 flex justify-end items-center grow gap-4"
            role="list"
          >
            <li>
              <Link href="/get-quote">
