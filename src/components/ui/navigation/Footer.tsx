...
export const Footer: React.FC = () => {
  return (
    ...
    >
            ...
            <ul className="mt-4 space-y-4" role="list">
              <li>
                <Link
                  ...
                  className="text-nowrap text-sm text-text-inverse hover:text-zinc-300 focus:text-zinc-300 focus:outline-none focus-visible:underline"
              ...
              <li>
                <Link
                  ...
                  className="text-nowrap text-sm text-text-inverse hover:text-zinc-300 focus:text-zinc-300 focus:outline-none focus-visible:underline"
                  aria-label="Estimate how much storage space you need"
                >
                  Storage Calculator
                </Link>
              </li>
            ...
            <div className="mt-4 space-y-4">
              ...
              <div>
                ...
                >
                  <a
                    ...
                    className="text-text-inverse hover:text-zinc-300 focus:text-zinc-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-text-inverse focus-visible:ring-offset-2 focus-visible:ring-offset-primary rounded"
              ...
              <div>
                <div className="pt-4 flex md:justify-end">
                  <Link href="/get-quote">
                    <button
                      className="block py-2.5 px-6 rounded-md font-semibold bg-white text-sm sm:hover:bg-slate-100 active:bg-slate-200 text-nowrap font-inter"
      ...
      <BoomboxLogo className="text-zinc-800 w-full mt-24" />
    </footer>
  );
};
