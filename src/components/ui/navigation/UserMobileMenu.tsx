/**
 * @fileoverview UserMobileMenu - Full-screen mobile menu for authenticated users
 * @source boombox-10.0/src/app/components/navbar/UserMobileMenu.tsx
 *
 * COMPONENT FUNCTIONALITY:
 * Provides full-screen mobile navigation overlay for authenticated users with
 * user-specific menu items and logout functionality. Features automatic route
 * change detection and body scroll lock.
 *
...
export const UserMobileMenu: React.FC<UserMobileMenuProps> = ({
  userId,
  className,
  theme = 'dark',
}) => {
