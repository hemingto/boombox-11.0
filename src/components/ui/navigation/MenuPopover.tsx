    ...
    return (
        <div className={`relative inline-block text-left ${className}`} ref={popoverRef}>
            <button
                ...
                className={`group flex text-sm cursor-pointer items-center gap-1 py-2.5 px-2.5 rounded-full transition-colors focus:outline-none ${
                    isDarkTheme
                        ...
                        <Link key={option.name} href={option.href}>
                            <li 
                                ...
                                className={`group flex h-10 space-x-4 items-center p-4 text-nowrap text-sm cursor-pointer focus:outline-none focus:bg-surface-tertiary ${
                                    'text-text-secondary hover:bg-surface-tertiary active:bg-surface-disabled group-hover:text-text-primary'
                                }`}
                            >
