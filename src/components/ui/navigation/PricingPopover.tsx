 ...
 return (
  <div className="relative inline-block text-left" ref={popoverRef}>
   ...
   {isOpen && (
    ...
    <div className="group relative leading-6 p-4 cursor-pointer hover:bg-surface-tertiary active:bg-surface-disabled" role="none">
     <Link 
      ...
      onClick={closeMenu}
     >
      <p className="pl-2 text-text-primary group-hover:text-primary">Learn more at our pricing page</p>
