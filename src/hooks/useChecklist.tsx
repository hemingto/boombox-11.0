...
const DEFAULT_CHECKLIST_ITEMS: ChecklistItem[] = [
  {
    ...
    description:
      'Make sure your items are packed in proper packing supplies. This will ensure your items are stored safely and securely. If you need packing supplies check out our packing supplies store. We can deliver your packing supplies right to your door before your pickup appointment.',
    isChecked: false,
  },
  {
    id: 2,
    title:
      'Disassemble all larger furniture items such as bed frames and dining tables',
    description:
      'We recommend you disassemble large furniture items to maximize your storage space as well as minimize the possibility of your items being damaged in transit.',
    isChecked: false,
  },
  {
    id: 3,
    title:
      'Measure all larger items to make sure they will fit into your Boombox',
    description:
      'Unsure if your larger items will fit? Check out our storage calculator to find out exactly what items will fit and the exact dimensions of your Boombox container.',
    isChecked: false,
  },
  {
    id: 4,
    ...
    description:
      'To ensure you remember whats in your Boombox, we recommend taking photos of the items you plan on storing. You can upload photos on your account page once your pickup is complete.',
    isChecked: false,
  },
  {
    id: 5,
    ...
    description:
      'To make sure your move goes smoothly make sure you provide additional information about your move. You can do so on the form we send over text or on your account page.',
    isChecked: false,
  },
  {
    id: 6,
    title:
      'Make sure you have read our terms of service and reviewed our storage guidelines',
    description: (
      <>
        You can find our storage guidelines{' '}
        <Link
        ...
        and you can find our terms page{' '}
        <Link
          href="/terms"
          className="font-semibold underline"
          onClick={e => e.stopPropagation()}
  ...
  {
    id: 7,
    title: 'Make sure to have a padlock for your unit',
    description:
      "A padlock is required to secure your Boombox container. If you don't have one handy, our driver can provide one at the time of pickup for an additional fee.",
    isChecked: false,
  },
];
