...
/**
 * Breakpoints for city name chips (longer text like "South San Francisco")
 */
export const DEFAULT_CITY_GRID_BREAKPOINTS: ResponsiveBreakpoint[] = [
  { maxWidth: 480, rowsPerPage: 4, itemsPerRow: 2 },
  { maxWidth: 640, rowsPerPage: 5, itemsPerRow: 2 },
  { maxWidth: 768, rowsPerPage: 5, itemsPerRow: 3 },
  { maxWidth: 1024, rowsPerPage: 5, itemsPerRow: 4 },
  { maxWidth: 1280, rowsPerPage: 5, itemsPerRow: 5 },
  { maxWidth: Infinity, rowsPerPage: 5, itemsPerRow: 6 },
];

/**
 * Breakpoints for zip code chips (short 5-digit text, can pack more per row)
 */
export const DEFAULT_ZIPCODE_GRID_BREAKPOINTS: ResponsiveBreakpoint[] = [
  { maxWidth: 480, rowsPerPage: 4, itemsPerRow: 3 },
  { maxWidth: 640, rowsPerPage: 5, itemsPerRow: 4 },
  { maxWidth: 768, rowsPerPage: 5, itemsPerRow: 5 },
  { maxWidth: 1024, rowsPerPage: 5, itemsPerRow: 7 },
  { maxWidth: 1280, rowsPerPage: 5, itemsPerRow: 8 },
  { maxWidth: Infinity, rowsPerPage: 5, itemsPerRow: 10 },
];
...
export function useResponsiveGridPagination<T>(
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener('resize', updatePaginationProperties);
