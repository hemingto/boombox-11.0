...
describe('useAddStorageSubmission', () => {
  ...
  describe('Form Submission Errors', () => {
    ...
    it('handles network errors', async () => {
      ...
      expect(result.current.submissionState.submitError).toBe(
  ...
  describe('Form Data Validation', () => {
    it('validates required user ID', async () => {
      ...
      expect(result.current.submissionState.submitError).toMatch(
        /validation|user|required/i
      );
    });
  ...
  describe('Edge Cases', () => {
    it('handles undefined form state', async () => {
      ...
      expect(result.current.submissionState.submitError).toBe(
        "Cannot read properties of undefined (reading 'scheduling')"
      );
      expect(mockFetch).not.toHaveBeenCalled();
    });
    ...
    it('handles null user ID', async () => {
      ...
      expect(result.current.submissionState.submitError).toContain(
        'Validation failed'
      );
    });
