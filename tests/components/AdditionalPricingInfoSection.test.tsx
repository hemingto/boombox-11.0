...
describe('AdditionalPricingInfoSection', () => {
  ...
  describe('Rendering', () => {
    it('renders without crashing', () => {
      ...
      expect(
        screen.getByRole('region', { name: /pricing information carousel/i })
      ).toBeInTheDocument();
    });
    ...
    it('renders the section heading', () => {
      ...
      expect(
        screen.getByRole('heading', {
          name: /additional pricing info/i,
          level: 1,
        })
      ).toBeInTheDocument();
    });
    ...
    it('renders all four pricing cards', () => {
      ...
      expect(screen.getByText('$75 flat rate')).toBeInTheDocument();
    ...
    it('renders all pricing card descriptions', () => {
      ...
      expect(
        screen.getByText(/Your Boombox is delivered right to your door/i)
      ).toBeInTheDocument();
      expect(
        screen.getByText(/We partner with local moving pros/i)
      ).toBeInTheDocument();
      expect(screen.getByText(/book a return delivery/i)).toBeInTheDocument();
      expect(
        screen.getByText(/Order boxes, tape, and more/i)
      ).toBeInTheDocument();
    });
    ...
    it('renders navigation buttons', () => {
      ...
      expect(
        screen.getByRole('button', { name: /scroll to previous pricing card/i })
      ).toBeInTheDocument();
      expect(
        screen.getByRole('button', { name: /scroll to next pricing card/i })
      ).toBeInTheDocument();
    });
  ...
  describe('Accessibility', () => {
    ...
    it('has proper ARIA labels on navigation buttons', () => {
      ...
      const prevButton = screen.getByRole('button', {
        name: /scroll to previous pricing card/i,
      });
      const nextButton = screen.getByRole('button', {
        name: /scroll to next pricing card/i,
      });

      expect(prevButton).toHaveAttribute(
        'aria-label',
        'Scroll to previous pricing card'
      );
      expect(nextButton).toHaveAttribute(
        'aria-label',
        'Scroll to next pricing card'
      );
    });
    ...
    it('has proper ARIA label on carousel container', () => {
      ...
      const carousel = screen.getByRole('region', {
        name: /pricing information carousel/i,
      });
      expect(carousel).toHaveAttribute(
        'aria-label',
        'Pricing information carousel'
      );
    });
    ...
    it('section has proper semantic HTML', () => {
      ...
      const section = screen.getByRole('region', {
        name: /additional pricing information/i,
      });
    ...
    it('navigation buttons have proper button type', () => {
      ...
      const prevButton = screen.getByRole('button', {
        name: /scroll to previous/i,
      });
      const nextButton = screen.getByRole('button', {
        name: /scroll to next/i,
      });
